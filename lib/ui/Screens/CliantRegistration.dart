...
class CliantRegistration extends StatefulWidget {
  @override
  _CliantRegistrationState createState() => _CliantRegistrationState();
}

class _CliantRegistrationState extends State<CliantRegistration> {
    ...
    return Container(
      child: Scaffold(
        appBar: AppBar(
            centerTitle: true,
            title: Text(
              translator.translate('CustomersRegisteration'),
    ...
    return ListTile(
      title: Row(
        children: [
          ...
          Text(translator.translate('CustomersRegisteration'))
        ],
      ),
      subtitle:
          Text(translator.translate('Register_customers_from_here')),
    );
  }
}
